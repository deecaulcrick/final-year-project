...
export const metadata: Metadata = {
  title: "AI-Assisted EMR/EHR SaaS Platform for Nigerian Primary Care",
  description: "Documentation of my undergraduate final year design science research project.",
};
